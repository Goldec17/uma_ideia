    ...
    def widgets_janela(self):
        ...
        def logar():
            ...
            if self.id_acess == "" or self.pass_user == "":
                ...
                self.label_incorrect.place(relx=0.2, rely=0.01, relwidth=0.6, relheigh=0.05)
            ...
            if len(self.buscar_users) >= 1:
                ...
                for chave, valor in self.buscar_pass.items():
                    if num2 == num:
                        if valor == self.dados["pass-user"]:
                            ...
                            self.label_acess_sucess.place(relx=0.2, rely=0.01, relwidth=0.6, relheigh=0.05)
                ...
                self.label_un_user.place(relx=0.2, rely=0.01, relwidth=0.6, relheigh=0.05)
            ...
            if len(self.buscar_users) >= 1:
                ...
                for chave, valor in self.buscar_users.items():
                    if valor == self.dados["id-acess"]:
                        ...
                        self.label_reg_sucess.place(relx=0.2, rely=0.01, relwidth=0.6, relheigh=0.05)
                        self.label_reg_sucess.configure(bg="white", font="consolas 12 bold")
                        return
                    else:
                        continue
                    num += 1
                if num == len(self.buscar_users):
